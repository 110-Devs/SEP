...
const environment = {
  ...
  SYSTEM_PROMPT:
    ...
    "Above is a JSON representation of the webpage's structure, including class attributes and the shortest selector for each element. This is only the main-tag you are given. So only do changes within the main-tag (class: A01). " + 
